...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_chunk_embeddings_sheet_id'), 'chunk_embeddings', ['sheet_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_chunk_embeddings_sheet_id'), table_name='chunk_embeddings')
